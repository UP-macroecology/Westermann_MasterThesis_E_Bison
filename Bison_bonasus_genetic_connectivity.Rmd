...
---
This script is for my research of my Master thesis. ADD MORE DESCRIPTIVE TEXT
# Load libraries
```{r setup}
library(RangeShiftR)
library(tictoc)
...
#ggsave(filename = "Plots/Allelic_div_over_time_ind_populations.png")
# Maybe exclude Rothaar?
# Overall (not per population) WITHOUT Rothaar
#ggplot(Allelic_div_combined[Allelic_div_combined$Patch_Name != "Rothaar",], aes(x = Year, y = A)) +
 # geom_smooth(method = "lm") +
  #labs(title = "Allelic Diversity Over Time") +
  #theme_minimal() +
  #facet_wrap(~Source) +
  #ggtitle("Allelic diversity across all populations over time (excluding Rothaar)")

#ggplot(Allelic_div_combined[Allelic_div_combined$Patch_Name != "Rothaar",], aes(x = Year, y = A, colour = Patch_Name)) +
 # geom_smooth(method = "lm") +
  #labs(title = "Allelic Diversity Over Time") +
  #theme_minimal() +
  #facet_wrap(~Source) +
  #ggtitle("Allelic diversity in individual populations over time (excluding Rothaar)")
